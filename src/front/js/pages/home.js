...
import fondo from "./../../img/fondoCine.jpg";
...
export const Home = () => {
  ...
  return (
    <div className="home-container d-flex justify-content-center align-items-center" style={{ fontFamily: "Agbalumo", backgroundColor: "rgb(8, 19, 36)" }}>
